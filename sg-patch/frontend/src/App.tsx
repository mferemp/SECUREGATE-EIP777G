      ...
      <div className="sg-shell">
        ...
        <aside className="sg-sidebar" aria-label="Auth-Gate">
          ...
          <div className="sg-side-caution" role="note" aria-label="Caution">
            ...
            <p>This wallet is in recovery mode.</p>
            <p>Access is restricted until verified.</p>
            <p>Unauthorized attempts are logged.</p>
            <p className="sg-side-caution-warn">Proceed only if you are the owner.</p>
            <button
        ...
        <main className="sg-main" style={{ display: 'grid', gap: 20 }}>
          ...
          <section className="sg-standalone" aria-label="Standalone operation">
            ...
            <p>Chain checks stay backend-routed.</p>
            <p>Endpoint details are never shown in the browser.</p>
          </section>
